            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">  Tenant Details</h2>
                        <a href="addTenants.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Tenant</a>
                    </div>
                    <?php
                    // Include config file
